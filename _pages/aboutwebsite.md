...
The website, adapted from [the Allan Lab website](https://github.com/allanlab/allanlab), introduces further modifications to simplify data updates. The website now has the ability to use Google Sheets as data sources instead of markdown files. Moreover, the Google Sheets can be updated with Forms for a streamlined update process!

Details for this are yet to be added, but you can check out the source on [Github](https://github.com/csndl-iitd/cndl-website/).
